...
def fetch_flights():
    ...
    new_itinerary = {
        ...
        'legs': [
            {
                'id': 'new_leg_1',
                'origin': {'id': 'SAN', 'name': 'San Diego International', 'displayCode': 'SAN', 'city': 'San Diego', 'country': 'United States'},
                'destination': {'id': 'MUC', 'name': 'Munich International', 'displayCode': 'MUC', 'city': 'Munich', 'country': 'Germany'},
                'departure': '2024-12-11T17:20:00',
                'arrival': '2024-12-12T13:25:00',
                'durationInMinutes': 665,
                'flightNumber': 'LH467',
                'carriers': {
                    'marketing': [{'id': -32090, 'logoUrl': 'https://logos.skyscnr.com/images/airlines/favicon/LH.png', 'name': 'Lufthansa'}],
                    'operating': [{'id': -32090, 'logoUrl': 'https://logos.skyscnr.com/images/airlines/favicon/LH.png', 'name': 'Lufthansa'}]
                },
                'details': {
                    'depart_time': '05:20pm - San Diego International Airport (SAN)',
                    'travel_time': '11h 5m',
                    'arrival_time': '01:25pm - Munich International (MUC)',
                    'flight_info': 'Lufthansa / LH 467 / Eco Light / A350 (widebody)',
                    'next_day_arrival': 'This flight arrives the next day on Thu, Dec 12'
                }
            },
            {
                'id': 'new_leg_2',
                'origin': {'id': 'MUC', 'name': 'Munich International', 'displayCode': 'MUC', 'city': 'Munich', 'country': 'Germany'},
                'destination': {'id': 'FRA', 'name': 'Frankfurt International Airport', 'displayCode': 'FRA', 'city': 'Frankfurt', 'country': 'Germany'},
                'departure': '2024-12-12T19:00:00',
                'arrival': '2024-12-12T20:05:00',
                ...
                'details': {
                    'layover_time': '5h 35m layover in MUC',
                    'connecting_flight': 'Connecting flight departs on Thu, Dec 12',
                    'depart_time': '07:00pm - Munich International (MUC)',
                    'travel_time': '1h 5m',
                    'arrival_time': '08:05pm - Frankfurt International Airport (FRA)',
                    'flight_info': 'Lufthansa / LH 119 / Eco Light / A350 (widebody)'
                }
            },
            {
                'id': 'new_leg_3',
                'origin': {'id': 'FRA', 'name': 'Frankfurt International Airport', 'displayCode': 'FRA', 'city': 'Frankfurt', 'country': 'Germany'},
                'destination': {'id': 'VNO', 'name': 'Vilnius International Airport', 'displayCode': 'VNO', 'city': 'Vilnius', 'country': 'Lithuania'},
                'departure': '2024-12-12T20:50:00',
                'arrival': '2024-12-12T23:55:00',
                ...
                'details': {
                    'layover_time': '45m layover in FRA',
                    'depart_time': '08:50pm - Frankfurt International Airport (FRA)',
                    'travel_time': '2h 5m',
                    'arrival_time': '11:55pm - Vilnius International Airport (VNO)',
                    'flight_info': 'Lufthansa / LH 888 / Eco Light / A350 (widebody)'
                }
            }
        ],
